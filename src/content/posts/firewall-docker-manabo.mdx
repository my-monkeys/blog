...
<Mermaid
  caption="Chemin réseau avant le fix : UFW droppe silencieusement les paquets Caddy → host"
  code={`
flowchart LR
...
<Callout type="fix">
Une seule règle UFW à ajouter, et c'est réparé.
</Callout>
...
<CodeDiff
  lang="bash"
  beforeLabel="Avant : aucune règle pour 3456"
  afterLabel="Après : range Docker autorisé"
  caption="sudo ufw status numbered"
